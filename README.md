...
### Неделя 9. Немного вопросов и ответов :)

L1. Сезонность сложной структуры

L2. Данные прерывающиеся нулями

L3. Тест Диболда-Мариано

L4. Иерархические и сгруппированные ряды

L5. Оптимальное согласование прогнозов

R1. Сезонность сложной структуры

R2. Алгоритм Кростона

R3. Согласование прогнозов
