...
L5. О некорректных моделях 

некорректная кросс-валидация работает!

модель, с нарушенными предпосылками может вполне давать хорошие прогнозы!

L6. Прямая и рекуррентная стратегии прогнозирования.
...
L4. Байсовский подход и структурные модели. 

L5. Оценивание эффекта воздействия. 
