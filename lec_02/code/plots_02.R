...
fcst %>% autoplot(filter(marr_rf, date > ymd('2019-01-01'))) + labs(title = "ETS(ANN)", y = "Число свадеб, тыс.", x = NULL) +
...
fcst %>% autoplot(filter(marr_rf_fake, date > ymd('2017-01-01'))) +
  labs(title = "ETS(AAN)", y = "Число свадеб, тыс.", x = NULL) +
  theme_light() + theme(legend.position = "none")
...
fcst %>% autoplot(filter(marr_rf_fake, date > ymd('2016-01-01'))) +
  labs(title = "ETS(AAA)", y = "Число свадеб, тыс.", x = NULL) +
  theme_light() + theme(legend.position = "none")
